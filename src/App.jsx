        ...
        <header className="mb-12 flex flex-col md:flex-row justify-between items-end gap-6 animate-fade-in">
          <div className="w-full md:w-auto">
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-indigo-900 font-bold tracking-widest uppercase text-xs">{greeting}, Future Engineer</p>
            </div>
          ...
          <div className="flex items-center gap-4 w-full md:w-auto">
             ...
             <div className="glass-panel px-6 py-3 rounded-2xl flex items-center gap-4">
                ...
                <div className="text-center">
                   <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Wk</p>
                   <p className="text-lg font-serif font-bold text-indigo-900 leading-none">05</p>
                </div>
             </div>
          </div>
        </header>
          ...
          <div className="glass-panel rounded-3xl p-6 lg:col-span-1 flex flex-col justify-between animate-slide-up relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-end gap-2 mb-2">
                <span className="text-4xl font-bold text-indigo-900">85</span>
                <span className="text-lg font-medium text-slate-400 mb-1">/ 100</span>
              </div>
              
              <div className="w-full bg-slate-100 rounded-full h-2 mb-4 overflow-hidden">
                <div className="bg-indigo-900 h-2 rounded-full w-[85%] transition-all duration-1000 ease-out group-hover:w-[87%]"></div>
              </div>
